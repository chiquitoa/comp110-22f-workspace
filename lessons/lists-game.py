...
# print(f"The first roll was {rolls[0]}")
# print(f"The second roll was {rolls[1]}")
# print(f"The third roll was {rolls[2]}")

# # Access the length of a list (number of items)
# print(f"The total number of rolls was {len(rolls)}")
